...
| Character dialogue shot, low/medium motion | `wan-2-7-image-to-video` | synthesizes lip-sync from supplied `audio_url`; min 3s audio (use audio pre-flight pad). Inherits aspect from input image. |
